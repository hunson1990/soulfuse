...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'pollo',
      title: 'Pollo',
      description: `Custom <a href="https://pollo.ai" class="text-primary" target="_blank">Pollo</a> settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      placeholder: 'xxx',
      group: 'pollo',
      tip: 'Pollo API Key is used to access the Pollo API',
      tab: 'ai',
    },
    {
      name: 'pollo_base_url',
      title: 'Pollo Base URL',
      type: 'url',
      placeholder: 'https://api.pollo.ai/v1',
      group: 'pollo',
      tip: 'Pollo API base URL',
      tab: 'ai',
    },
    {
      name: 'pollo_custom_storage',
      title: 'Pollo Custom Storage',
      type: 'switch',
      value: 'false',
      group: 'pollo',
      tab: 'ai',
      tip: 'Use custom storage to save files generated by Pollo',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
